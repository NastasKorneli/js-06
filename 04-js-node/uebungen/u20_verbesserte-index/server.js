...
fs.readFile(CSV_PATH, 'UTF-8', (error, data) => {
  ...
  // TODO: anstatt id product "code" als routenparameter abfangen
  app.get('/product/:id', (req, res) => {
    const idx = req.params.id - 1;
    // TODO: Vom entries Array über product "code" passendes product Objekt auslesen und an Template weitergeben
...
// Übung 20: Eine verbesserte Indexseite

// Pass das Template index.ejs so an, dass die Indexseite übersichtlicher wird. Die Links auf die Produkte sollen die Kurzbeschreibung des Produkts enthalten, wie im folgenden Screenshot zu sehen:
